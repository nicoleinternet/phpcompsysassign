...
INSERT INTO `eoi` (`eoi_id`, `job_ref`, `status`, `first_name`, `last_name`, `email`, `phone_number`, `street_address`, `suburb_address`, `state_address`, `postcode`, `skill_1`, `skill_2`, `skill_3`, `skill_4`, `skill_5`, `miscinfo`, `dob`, `gender`) VALUES
(3, 'CS456', 'Current', 'Jane', 'Doe', 'jdoe@yahoo.com', '04111111', '5 Example Cr', 'Melbourne', 'VIC', 3000, NULL, NULL, NULL, NULL, NULL, 'I can perform this job well.', '0000-00-00', 'Woman');
...
(2, 'CS456', 'Cyber Security Analyst', 'Current', '</ul>\r\n<li>Monitor and analyze security alerts</li>\r\n<li>Implement and manage security tools</li>\r\n<li>Perform risk assessments and penetration testing</li>\r\n<li>Develop security awareness programs</li>\r\n</ul>', NULL, NULL, NULL, NULL, NULL);
